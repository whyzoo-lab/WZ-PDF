...
export const en = {
  ...
  'pdf.cannotDeleteAll': 'Every page cannot be deleted. At least one page must remain.',
  'pdf.selectPages': 'Select the pages to save.',
  'tts.failed': 'Reading aloud failed: {error}',
  'tts.a11yPreparing': 'Getting ready to read.',
  'tts.a11ySpeaking': 'Reading the document aloud. Alt with the left and right arrows moves a sentence at a time; Alt with space pauses.',
  'tts.a11yPaused': 'Reading paused.',
  'tts.a11yStopped': 'Reading finished.',
  'tts.controls': 'Read-aloud controls',
  'tts.previous': 'Previous sentence (Alt+Left)',
  'tts.next': 'Next sentence (Alt+Right)',
  'tts.a11yDownloading': 'Downloading the voice files. {pct} percent.',
  'ocr.a11yProgress': 'Recognizing text. Page {done} of {total}.',
  'ocr.a11yDone': 'Text recognition finished.',
  'ocr.a11ySingle': 'Recognizing the text on this page.',
  'page.a11yPage': 'Page {n}',
  'page.a11yImageOnly': 'Page {n}. An image with no text. Use the OCR button in the toolbar to recognise it.',
  'a11y.document': 'Document',
  'a11y.documentNamed': '{name} — {n} page document',
  'a11y.pageList': 'Page list',
  ...
  // ── OCR ───────────────────────────────────────────────────────────────────
  'ocr.runCurrent': 'OCR (current page) — R or Alt+R',
  'ocr.runAll': 'OCR (whole document) — R twice',
  ...
  // ── Read aloud ───────────────────────────────────────────────────────────
  'tts.read': 'Read aloud — S or Alt+S',
