...
export const ko = {
  ...
  'pdf.cannotDeleteAll': '페이지를 모두 삭제할 수 없습니다. 최소 1개 페이지는 남아야 합니다.',
  'pdf.selectPages': '저장할 페이지를 선택하세요.',
  'tts.failed': '읽어주기에 실패했습니다: {error}',
  'tts.a11yPreparing': '읽을 준비를 하고 있습니다.',
  'tts.a11ySpeaking': '문서를 읽는 중입니다. Alt와 왼쪽·오른쪽 화살표로 문장을 옮기고, Alt와 스페이스로 잠시 멈춥니다.',
  'tts.a11yPaused': '읽기를 일시정지했습니다.',
  'tts.a11yStopped': '읽기를 마쳤습니다.',
  'tts.controls': '읽어주기 조절',
  'tts.previous': '이전 문장 (Alt+←)',
  'tts.next': '다음 문장 (Alt+→)',
  'tts.a11yDownloading': '목소리 파일을 내려받는 중입니다. {pct}퍼센트.',
  'ocr.a11yProgress': '글자를 인식하는 중입니다. {total}쪽 가운데 {done}쪽.',
  'ocr.a11yDone': '글자 인식을 마쳤습니다.',
  'ocr.a11ySingle': '이 페이지의 글자를 인식하는 중입니다.',
  'page.a11yPage': '{n}쪽',
  'page.a11yImageOnly': '{n}쪽. 글자가 없는 그림 페이지입니다. 도구 모음의 OCR 단추로 글자를 인식하면 읽을 수 있습니다.',
  'a11y.document': '문서',
  'a11y.documentNamed': '{name} — {n}쪽 문서',
  'a11y.pageList': '페이지 목록',
  ...
  // ── OCR ───────────────────────────────────────────────────────────────────
  'ocr.runCurrent': 'OCR (현재 페이지) — R 또는 Alt+R',
  'ocr.runAll': 'OCR (전체 문서) — R 두 번',
