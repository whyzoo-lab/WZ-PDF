...
- 🖨️ **Mail and Markdown print, zoom and present too** — they print as *text*, so the output stays sharp and selectable instead of being a picture of a page, and F5 puts them fullscreen with the same presenter tools as a PDF.
